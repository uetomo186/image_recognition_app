...
class CameraScreen extends ConsumerWidget {
  ...
  final ResolutionPreset _resolutionPreset =
      ResolutionPreset.high; //high=1280x720
  ...
  Size cameraSize = Size(100.0, 100.0);
  Size screenSize = Size(100.0, 100.0);
  double _scale = 1.0;
  double _aspect = 1.0;
  bool bInit = false;
  late WidgetRef _ref;
        ...
        Center(
          child: Transform.scale(
            ...
            child: AspectRatio(
              ...
              child: CustomPaint(
                  size: cameraSize,
                  painter: VisionPainter(_vision, cameraSize, screenSize)),
            ),
          ),
        ),
  ...
  Widget typeButton(int index, VisionType type, IconData icon) {
    double top = _aspect > 1.0
        ? 30.0
        : index < 6
            ? 30.0
            : 30.0 + ICON_SPACE;
    double left =
        _aspect > 1.0 ? 20 + ICON_SPACE * index : 20 + ICON_SPACE * (index % 6);
